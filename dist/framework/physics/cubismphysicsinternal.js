...
(function (Live2DCubismFramework) {
    ...
    var CubismPhysicsParameter = /** @class */ (function () {
        function CubismPhysicsParameter() {
            this.id = undefined; // パラメータ
            this.targetType = undefined; // 適用先の種類
        }
    ...
    var CubismPhysicsNormalization = /** @class */ (function () {
        function CubismPhysicsNormalization() {
            this.minimum = undefined; // 最大値
            this.maximum = undefined; // 最小値
            this.defalut = undefined; // デフォルト値
        }
    ...
    var CubismPhysicsParticle = /** @class */ (function () {
        function CubismPhysicsParticle() {
            this.mobility = undefined; // 動きやすさ
            this.delay = undefined; // 遅れ
            this.acceleration = undefined; // 加速度
            this.radius = undefined; // 距離
    ...
    var CubismPhysicsSubRig = /** @class */ (function () {
        function CubismPhysicsSubRig() {
            this.inputCount = undefined; // 入力の個数
            this.outputCount = undefined; // 出力の個数
            this.particleCount = undefined; // 物理点の個数
            this.baseInputIndex = undefined; // 入力の最初のインデックス
            this.baseOutputIndex = undefined; // 出力の最初のインデックス
            this.baseParticleIndex = undefined; // 物理点の最初のインデックス
    ...
    var CubismPhysicsInput = /** @class */ (function () {
        function CubismPhysicsInput() {
            this.sourceParameterIndex = undefined; // 入力元のパラメータのインデックス
            this.weight = undefined; // 重み
            this.type = undefined; // 入力の種類
            this.reflect = undefined; // 値が反転されているかどうか
            this.getNormalizedParameterValue = undefined; // 正規化されたパラメータ値の取得関数
    ...
    var CubismPhysicsOutput = /** @class */ (function () {
        function CubismPhysicsOutput() {
            this.destinationParameterIndex = undefined; /// < 出力先のパラメータのインデックス
            this.vertexIndex = undefined; /// < 振り子のインデックス
            this.angleScale = undefined; /// < 角度のスケール
            this.weight = undefined; /// 重み
            this.type = undefined; /// < 出力の種類
            this.reflect = undefined; /// < 値が反転されているかどうか
            this.valueBelowMinimum = undefined; /// < 最小値を下回った時の値
            this.valueExceededMaximum = undefined; /// < 最大値をこえた時の値
            this.getValue = undefined; /// < 物理演算の値の取得関数
            this.getScale = undefined; /// < 物理演算のスケール値の取得関数
    ...
    var CubismPhysicsRig = /** @class */ (function () {
        function CubismPhysicsRig() {
            this.subRigCount = undefined; /// < 物理演算の物理点の個数
