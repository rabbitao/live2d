...
export namespace Live2DCubismFramework {
    ...
    export class CubismModelUserDataNode {
      public targetType: CubismIdHandle = undefined as any;   // ユーザーデータターゲットタイプ
      public targetId: CubismIdHandle = undefined as any;   // ユーザーデータターゲットのID
      public value: csmString = undefined as any;  // ユーザーデータ
    }
