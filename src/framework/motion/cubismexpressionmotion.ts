...
export namespace Live2DCubismFramework {
    ...
    export class ExpressionParameter {
      public parameterId: CubismIdHandle = undefined as any;          // パラメータID
      public blendType: ExpressionBlendType = undefined as any; // パラメータの演算種類
      public value: number = undefined as any;                  // 値
    }
}
