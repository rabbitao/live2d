...
export class TextureInfo {
  public img: HTMLImageElement = null as any;      // 画像
  public id: WebGLTexture = null as any;    // テクスチャ
    public width: number = 0;          // 横幅
    public height: number = 0;         // 高さ
    public usePremultply: boolean = false;     // Premult処理を有効にするか
    public fileName: string = '';           // ファイル名
}
